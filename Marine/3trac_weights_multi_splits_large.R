...
dat_list <- readRDS("marine_leucine_large_aggregated.RDS")
...
load("marine_leucine_large_trac_fixed_level_multi_splits.Rdata", envir = trac <- new.env())
stopifnot(identical(tr, trac$tr))
save(tr, fit, cvfit, yhat_tr, yhat_te, trainerr, testerr, nnz,
     file = "marine_leucine_large_trac_weights_fixed_level_multi_splits.Rdata")
