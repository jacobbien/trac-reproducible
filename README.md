This directory contains the code needed to fully reproduce all the data examples in the manuscript "Tree-Aggregated Predictive Modeling of Microbiome Data".
