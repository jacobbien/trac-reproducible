...
dat_list <- readRDS("cps_Mois_aggregated.RDS")
...
load("cps_Mois_trac_fixed_level_multi_splits.Rdata", envir = trac <- new.env())
stopifnot(identical(tr, trac$tr))
save(tr, fit, cvfit, yhat_tr, yhat_te, trainerr, testerr, nnz,
     file = "cps_Mois_trac_weights_fixed_level_multi_splits.Rdata")
