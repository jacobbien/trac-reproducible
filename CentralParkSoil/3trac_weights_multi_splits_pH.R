...
dat_list <- readRDS("cps_pH_aggregated.RDS")
...
load("cps_pH_trac_fixed_level_multi_splits.Rdata", envir = trac <- new.env())
stopifnot(identical(tr, trac$tr))
save(tr, fit, cvfit, yhat_tr, yhat_te, trainerr, testerr, nnz,
     file = "cps_pH_trac_weights_fixed_level_multi_splits.Rdata")
